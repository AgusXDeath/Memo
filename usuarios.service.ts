...
export class UsuariosService {
  ...
  private apiUrlGrupoFunciones = 'http://localhost/api-php2/public/index.php?resource=gruposfunciones';
  private apiUrlMensajes = 'http://localhost/api-php2/public/index.php?resource=mensajes';  // URL para mensaje
