...
export class UsuariosService {
  ...
  private apiUrlUsuarios = 'http://localhost/api-remote/public/index.php?resource=usuarios';
  private apiUrlGrupos = 'http://localhost/api-remote/public/index.php?resource=grupos';
  private apiUrlFunciones = 'http://localhost/api-remote/public/index.php?resource=funciones';
  private apiUrlGrupoFunciones = 'http://localhost/api-remote/public/index.php?resource=grupofunciones';
  private apiUrlLogin = 'http://localhost/api-remote/public/index.php?resource=login';
